        ...
        <div class="inner">
            ...
            <div class="form">
                <form action="post" class="sign-up-form">
                    ...
                    <div class="form-step step-3 last">
                        <div class="training-details-wrapper form-section">
                            <div class="input-wrapper condition type-select" data-condition="training-type">
                                <select name="training_type" id="<?php echo $widget_id ?>-training-type" required>
                            ...
                            <div class="input-wrapper condition-res type-number" data-condition="training-type"
                                ...
                                <input type="text" name="training_number" id="<?php echo $widget_id ?>-training-number"
                                    placeholder="מספר קפ״צ">
                            </div>
                        ...
                        <div class="journey-details-wrapper form-section">
                            <div class="input-wrapper type-select">
                                <select name="journey_date" id="<?php echo $widget_id ?>-journey-date" required>
                            ...
                            <div class="input-wrapper type-checkbox">
                                <input type="checkbox" name="flexability" id="<?php echo $widget_id ?>-flexability"
                                    value="1">
                                <label for="<?php echo $widget_id ?>-flexability">יש לי גמישות בתאריכים</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="journey_id" class="journey-id" value="<?php echo $journey_data['id'] ?>">
                    <div class="form-loader">
                        <?php echo wp_get_attachment_image($settings['loader_icon']['id']) ?>
                    </div>
                </form>
            </div>
